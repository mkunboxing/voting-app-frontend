    ...
    <AppBar position="sticky">
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          <Avatar alt='Voting App Logo' src={logo} sx={{ display: { xs: 'none', md: 'flex' }, mr: 1 }} />
          <Typography
            variant="h6"
            noWrap
            component="a"
            ...
            >
              {pages.map((page) => (
                <MenuItem key={page.path} component={Link} to={page.path} onClick={handleCloseNavMenu}>
                  <Typography>{page.name || page.label}</Typography>
                </MenuItem>
              ))}
            </Menu>
          </Box>
          {/* <AdbIcon sx={{ display: { xs: 'flex', md: 'none' }, mr: 1 }} /> */}
          <Avatar alt='Voting App Logo' src={logo} sx={{ display: { xs: 'flex', md: 'none' }, mr: 1 }} />
          <Typography
            variant="h6"
            noWrap
            component="a"
