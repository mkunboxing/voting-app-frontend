  ...
  return (
    <div>
      ...
      {candidates.map((candidate, index) => (
        <div key={candidate._id || index} style={{ display: "flex", flexDirection: "column", justifyContent: "center",
        alignItems: "center", marginBottom: "10px", border: "1px solid black", padding: "5px" }}>
